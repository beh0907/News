...
import com.skymilk.news.presentation.Dimens.SearchBarHorizontalPadding
...
fun SearchBar(
    ...
    Box(modifier = modifier) {
        TextField(
            ...
            placeholder = {
                Text(
                    text = "검색어를 입력해주세요.", style = MaterialTheme.typography.bodySmall.copy(
                        color = colorResource(
